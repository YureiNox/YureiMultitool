...
Ce projet est sous licence Apache 2.0. Vous pouvez librement l'utiliser, le modifier et le distribuer tant que vous respectez les termes de la licence.

Pour plus de détails, veuillez consulter le fichier [LICENSE](./LICENSE) inclus dans ce projet ou consulter la licence complète à l'adresse suivante : [http://www.apache.org/licenses/LICENSE-2.0](http://www.apache.org/licenses/LICENSE-2.0).
